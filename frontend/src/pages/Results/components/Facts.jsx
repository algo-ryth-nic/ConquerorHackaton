...
export default function Facts({ module, results }) {
  // skin - burn
  switch (module) {
    case "skin-burn":
      if (results.predicted_class_idx === 0) return <LightBurnSteps />;
      else if (results.predicted_class_idx === 1) return <ModerateBurnSteps />;
    case "pox-viruses":
      if (results.predicted_class_idx === 3) return <MonkeyPoxFacts />;
      if (results.predicted_class_idx === 0) return <ChickenPoxFacts />;
  }
